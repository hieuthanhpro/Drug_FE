        ...
        columns: [
          ...
          },
          {
            ...
            ul: [
              ...
              {
                text: ["Địa chỉ: ", { text: info.drug_store?.address, bold: true }],
                alignment: "center",
              },
              {
                text: ["Người xuất: ", { text: info.name, bold: true }],
                alignment: "center",
              },
              {
                text: ["Thời gian xuất: ", { text: moment().format("DD/MM/YYYY HH:mm:ss"), bold: true }],
                alignment: "center",
              },
            ],
          },
